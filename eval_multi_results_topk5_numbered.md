...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | How long can I borrow a laptop for? | laptop-policy.md | 0.709 | 5.9 | no | yes | yes | yes | yes | **PARTIAL** |
| 2 | How much is the deposit for a laptop? | laptop-policy.md | 0.625 | 5.0 | no | yes | yes | yes | yes | **PASS** |
| 3 | How much is the filament deposit for the 3D printer? | printing-guide.md | 0.708 | 5.2 | no | yes | yes | yes | yes | **PASS** |
| 4 | How far in advance do I have to book the 3D printer? | printing-guide.md | 0.694 | 5.6 | no | yes | yes | yes | yes | **PASS** |
| 5 | How long is a lab induction valid for? | lab-safety.md | 0.755 | 5.4 | no | yes | yes | yes | yes | **PASS** |
| 6 | When are the lab induction sessions held? | lab-safety.md | 0.710 | 5.6 | no | yes | yes | yes | yes | **PARTIAL** |
| 7 | How much does membership cost? | membership-faq.md | 0.633 | 4.9 | no | yes | yes | yes | yes | **PASS** |
| 8 | When does the club meet? | membership-faq.md | 0.593 | 5.2 | no | yes | yes | yes | yes | **PASS** |
| 9 | Which filament types are allowed in the 3D printer? | printing-guide.md | 0.610 | 5.2 | no | yes | yes | yes | yes | **PASS** |
| 10 | I have never been to the workshop. What do I need before I can book... | printing-guide.md | 0.716 | 8.0 | no | yes | yes | yes | yes | **PASS** |
| 11 | Who do I report a workshop injury to, and how quickly? | lab-safety.md | 0.565 | 4.7 | no | yes | yes | yes | yes | **PASS** |
| 12 | Is there a coffee machine in the workshop? | – | 0.433 | 3.7 | no | – | – | yes | – | **PASS** |
...
- Top score: 0.709  ·  5.9s  ·  gated: no
- **Cited the wrong file:** membership-faq.md, printing-guide.md
- Verdict: **PARTIAL**

> You can borrow a laptop for **two weeks** at a time.
...
> The deposit for a laptop is **500 TL** as stated in.
...
- Cited: `printing-guide.md`
- Top score: 0.694  ·  5.6s  ·  gated: no
- Verdict: **PASS**

> You must book the 3D printer **at least 48 hours in advance**. This information is found in the context.
...
- Cited: `lab-safety.md`, `membership-faq.md`
- Top score: 0.710  ·  5.6s  ·  gated: no
- **Cited the wrong file:** membership-faq.md
- Verdict: **PARTIAL**

> The lab induction sessions are held on the **first Monday of each month at 10:00** in the workshop.
...
- Cited: `membership-faq.md`
- Top score: 0.593  ·  5.2s  ·  gated: no
- Verdict: **PASS**

> The club meets every Thursday at 18:00 in Room B204.
...
- Cited: `printing-guide.md`
- Top score: 0.716  ·  8.0s  ·  gated: no
- Verdict: **PASS**

> Before you can book the 3D printer, you need to have a **valid lab induction**. Induction sessions are held on the **first Monday of each month at 10:00** in the workshop. After induction, you can then book the printer.
...
> You should report a workshop injury to the lab coordinator within 24 hours, as stated in.
